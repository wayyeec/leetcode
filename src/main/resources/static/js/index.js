    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","https://cwy-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/qq_code.png");
        $('.weixin_code').attr("src","https://cwy-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/weixin_code.png");
    });
