    ...
    function putInArticle(data) {
        $('.cwy-article-top').html('');
        $('.cwy-article-footer').html('');
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。<span class="article-i-say-me">--- wayyee</span>' +
            '</div>');
        $('.cwy-article-top').append(articleTop);
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '<img src="https://cwy-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/weixin.jpg">' +
            '</p>' +
            ...
            '</span>' +
            '</div>');
        $('.cwy-article-footer').append(articleFooter);
    ...
    $.ajax({
        ...
        success:function (data) {
            if(data.status == "200"){
                ...
                $('.content').html('');
                var error = $('<div class="article"><div class="cwy-article-top"><div class="error">' +
                    '<img src="https://cwy-myblog.oss-cn-shenzhen.aliyuncs.com/static/img/register_success.jpg">' +
                    '<p>没有找到这篇文章哦</p>' +
                    '<p>可能不小心被博主手残删掉了吧</p>' +
                    '<div class="row">' +
                    '<a href="/">返回首页</a>' +
